...
public class ApiRegisterUserRequest: APIModel {
    ...
    public init(company: String? = nil, consents: [ApiUserConsent]? = nil, email: String? = nil, firstName: String? = nil, gender: String? = nil, lastName: String? = nil, password: String? = nil, phone: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ApiRegisterUserRequest else { return false }
    ...
    public static func == (lhs: ApiRegisterUserRequest, rhs: ApiRegisterUserRequest) -> Bool {
