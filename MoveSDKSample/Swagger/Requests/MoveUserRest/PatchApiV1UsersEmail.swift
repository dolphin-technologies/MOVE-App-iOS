...
extension API.MoveUserRest {
    ...
    public enum PatchApiV1UsersEmail {

        public static let service = APIService<Response>(id: "patchApiV1UsersEmail", tag: "MoveUserRest", method: "PATCH", path: "/api/v1/users/email", hasBody: true, securityRequirements: [SecurityRequirement(type: "clientName", scopes: []), SecurityRequirement(type: "clientName", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: ApiValidateEmailHashRequest

            public init(body: ApiValidateEmailHashRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: PatchApiV1UsersEmail.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(xAppContractid: String? = nil, body: ApiValidateEmailHashRequest) {
