...
extension API.MoveUserRest {
    ...
    public enum PutApiV1UsersEmail {

        public static let service = APIService<Response>(id: "putApiV1UsersEmail", tag: "MoveUserRest", method: "PUT", path: "/api/v1/users/email", hasBody: true, securityRequirements: [SecurityRequirement(type: "clientName", scopes: []), SecurityRequirement(type: "clientName", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: ApiChangeContractDataRequest, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: PutApiV1UsersEmail.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(xAppContractid: String? = nil, body: ApiChangeContractDataRequest) {
