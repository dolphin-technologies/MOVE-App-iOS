...
extension API.PushRest {
    ...
    public enum GetApiV1Messages {

        public static let service = APIService<Response>(id: "getApiV1Messages", tag: "PushRest", method: "GET", path: "/api/v1/messages", hasBody: false, securityRequirements: [SecurityRequirement(type: "timestamp", scopes: []), SecurityRequirement(type: "hash", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetApiV1Messages.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(xAppContractid: String? = nil, date: String? = nil) {
